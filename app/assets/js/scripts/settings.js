...
function populateAuthAccounts(){
    ...
    authKeys.forEach((val) => {
        ...
        // For offline accounts, use a default skin image
        const skinSrc = acc.type === 'offline'
            ? 'https://mc-heads.net/body/MHF_Steve/60'
            : `https://mc-heads.net/body/${acc.uuid}/60`

        const accHtml = `<div class="settingsAuthAccount" uuid="${acc.uuid}">
            <div class="settingsAuthAccountLeft">
                <img class="settingsAuthAccountImage" alt="${acc.displayName}" src="${skinSrc}">
            </div>
...
function populateReleaseNotes(){
    $.ajax({
        url: 'https://github.com/sharkz-dev/minemon-launcher/releases.atom',
        success: (data) => {
